	...
	do {
		...
		case 3:
			cout << "\tFibonacci Examples:\n";
			{
				...
				//cout << "\tyour code here\n";
				int N = sizeof(nlist3) / sizeof(nlist3[0]);
				for (int i = 0; i < N; i++) {
		...
		case 4:
			cout << "\tBunnyEars Examples:\n";
			{
				...
				int N = sizeof(nlist4) / sizeof(nlist4[0]);
				for (int i = 0; i < N; i++) {
					cout << bunnyEars(nlist4[i]) << endl;
				}
		...
		case 6:
			cout << "\tTriangle Examples:\n";
			{
				...
				int N = sizeof(nlist6) / sizeof(nlist6[0]);
				for (int i = 0; i < N; i++) {
					cout << triangle(nlist6[i]) << endl;
				}
			}
			break;
		case 7:
			cout << "\tSum Digits Examples:\n";
			{
				...
				int N = sizeof(nlist7) / sizeof(nlist7[0]);
				for (int i = 0; i < N; i++) {
					cout << sumDigits(nlist7[i]) << endl;
				}
			}
			break;
		...
		case 8:
			cout << "\tCount 8 Examples:\n";
			{
				...
				int N = sizeof(nlist8) / sizeof(nlist8[0]);
				for (int i = 0; i < N; i++) {
					cout << count8(nlist8[i]) << endl;
				}
			}
			break;
		...
		case 9:
			cout << "\tPower N Examples:\n";
			{
				...
				for (auto i : p) {
					cout << powerN(i.first, i.second) << endl;
				}
			}
			break;
