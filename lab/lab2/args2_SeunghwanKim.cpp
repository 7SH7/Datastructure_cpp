...
int main(int argc, char *argv[]) {
	...
	cout << "Print using printfunc(**argv)" << endl;
	...
	cout << "Copy using vector<string>" << endl;
	cout << "Print names using indexing, but not ranged-for" << endl;
	...
	cout << "Print names using printfunc(vector<string> n)\n";
