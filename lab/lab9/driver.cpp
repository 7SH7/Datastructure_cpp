...
int main(int argc, char **argv)
{
	...
	do
	{
		...
		cout << "\tg - grow\t";
		cout << "\ta - grow a leaf    [BT]\n";
		cout << "\tt - trim*\t";
		cout << "\td - trim a leaf    [BT]\n";
		cout << "\tG - grow N\t";
		cout << "\tA - grow by Level  [BT]\n";
		cout << "\tT - trim N\t";
		cout << "\tf - find node      [BT]\n";
		cout << "\to - BST or AVL?\t";
		cout << "\tp - find path&back [BT]\n";
		cout << "\tr - rebalance tree**";
		cout << "\tl - traverse       [BT]\n";
		cout << "\tL - LCA*       \t";
		cout << "\tB - LCA*           [BT]\n";
		cout << "\tm - menu [BST]/[AVL]**";
		cout << "\tC - convert BT to BST*\n";
		cout << "\tc - clear\t";
		cout << "\ts - show mode:" << showMenu[showMode] << endl;
